...
?>
    ...
    <div class="gui gui-reset">
    <div class="gui-col2-left">
        <form method="post" class="woocommerce-ResetPassword lost_reset_password">
            <div class="gui-page-title" aria-level="1" role="heading"><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce' ) ); ?></div><?php // @codingStandardsIgnoreLine ?>

            <div class="gui-field reset-field">
                <label for="password_1"><?php esc_html_e( 'New password', 'woocommerce' ); ?>&nbsp;<em>*</em></label>
                <div class="gui-input">
            ...
            <div class="gui-field reset-field">
                <label for="password_2"><?php esc_html_e( 'Re-enter new password', 'woocommerce' ); ?>&nbsp;<em>*</em></label>
                <div class="gui-input">
