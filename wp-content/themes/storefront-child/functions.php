...
function register_post_types()
{
    ...
    register_post_type('specialities', [
        'label' => null,
        'labels' => [
            'name' => 'Specialities', // основное название для типа записи
            'singular_name' => 'Speciality', // название для одной записи этого типа
            'add_new' => 'Add speciality', // для добавления новой записи
            'add_new_item' => 'Add speciality', // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item' => 'Edit speciality', // для редактирования типа записи
            'new_item' => 'New speciality', // текст новой записи
            'view_item' => 'View speciality', // для просмотра записи этого типа.
            'search_items' => 'Search speciality', // для поиска по этим типам записи
            'not_found' => 'Not found', // если в результате поиска ничего не было найдено
            'not_found_in_trash' => 'Not found in trash', // если не было найдено в корзине
            'parent_item_colon' => '', // для родителей (у древовидных типов)
            'menu_name' => 'Speciality', // название меню
        ],
        'capability_type' => 'post',
        'capabilities' => [
            'create_posts' => false,
